...
def main():
    ...
    #even_better_draw_circles(rg.Point(-50,40),20,12,'light green',7)

    even_better_draw_circles(rg.Point(-65,25),7,7,'red',7)
    even_better_draw_circles(rg.Point(65,25),7,7,'red',7)
    better_draw_circles(rg.Point(0,-75),4)
...
def even_better_draw_circles(point,rad,num,color,thicc):
    ...
    for k in range(1, num+1):  # k becomes 1, 2, 3, ... 10
