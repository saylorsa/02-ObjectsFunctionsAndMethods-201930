...
def try_methods_and_functions():
    ...
    ###########################################################################
    multiturtle=rg.SimpleTurtle()
    multiturtle.pen=rg.Pen('blue',5)

    multiturtle.backward(150)

    multiturtle.speed=1
    draw_many_squares(multiturtle,2,100,30)

    multiturtle.speed=5
    multiturtle.pen=rg.Pen('red',5)
    draw_many_squares(multiturtle,10,50,15)

    multiturtle.speed=100
    multiturtle.pen=rg.Pen('red',35)
    draw_many_squares(multiturtle,8,300,60)

    multiturtle.pen=rg.Pen('black',3)

    multiturtle.backward(200)

    multiturtle.draw_circle(30)

    multiturtle.draw_square(50)
